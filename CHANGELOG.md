...
## [17.0.1](https://github.com/bkzhn/YouTube.js/compare/v18.1.0...v17.0.1) (2026-09-24)


### ⚠ BREAKING CHANGES

* **Comments.ts:** Add support for threaded comments ([#1194](https://github.com/bkzhn/YouTube.js/issues/1194))
* **Search:** Update search filters to match YouTube changes ([#1136](https://github.com/bkzhn/YouTube.js/issues/1136))
* **Innertube:** Remove getTrending as YouTube removed the trending feed ([#1114](https://github.com/bkzhn/YouTube.js/issues/1114))
...
* **Channel:** add methods for show tab ([#1260](https://github.com/bkzhn/YouTube.js/issues/1260)) ([d252b36](https://github.com/bkzhn/YouTube.js/commit/d252b36f7e0bf5926a52a589a73d4aa6392a9683))
* **ChipBarView:** Parse `renderer_context` ([3915883](https://github.com/bkzhn/YouTube.js/commit/39158838f1b4a8c414ddbabd94b5a48198b16b2f))
* **ChipView:** Improve types ([32623de](https://github.com/bkzhn/YouTube.js/commit/32623de4850fb2ae27c2b8317c2d00fea1a78227))
* **Collaborators:** Add `Author#collaborators` and `Playlist#getCollaborators()` ([#1203](https://github.com/bkzhn/YouTube.js/issues/1203)) ([049f9a6](https://github.com/bkzhn/YouTube.js/commit/049f9a6381aafb0fc57ec5558a955188e8a24b4b))
...
* **Format:** Add support for Voice Boost & Super Resolution formats ([#1092](https://github.com/bkzhn/YouTube.js/issues/1092)) ([769721c](https://github.com/bkzhn/YouTube.js/commit/769721c193f2073522a9d35708a07dc8b493f1c7))
...
* **GridPlaylist:** Add `thumbnail_overlays` ([#1263](https://github.com/bkzhn/YouTube.js/issues/1263)) ([30efa61](https://github.com/bkzhn/YouTube.js/commit/30efa610075a5911b9226991d80ae5ffc7840c16))
...
* **ListView:** Add some missing fields ([cf54129](https://github.com/bkzhn/YouTube.js/commit/cf5412986b102be7e8e11c87a0d877249caedce5))
...
* **LockupView:** Add show as possible `content_type` ([#1262](https://github.com/bkzhn/YouTube.js/issues/1262)) ([2b80e3e](https://github.com/bkzhn/YouTube.js/commit/2b80e3ef35f658bb2af573aa5f84b79d928e58d0))
* **LockupView:** Add station as possible `content_type` ([#1229](https://github.com/bkzhn/YouTube.js/issues/1229)) ([cfc7604](https://github.com/bkzhn/YouTube.js/commit/cfc7604f51e19a935b1a1711a42419ed3fabe5c3))
...
* **parser:** add 'attributionText' to HowThisWasMadeSectionView ([ef3afbe](https://github.com/bkzhn/YouTube.js/commit/ef3afbe435edc86ba3357b6fa951548ee3d46053))
...
* **Parser:** Add `HypeFanCreditsSectionView` ([853a363](https://github.com/bkzhn/YouTube.js/commit/853a36307b5d644ada14dcb1216c2c22c2ae7b73))
...
* **parser:** Add `PlayerInterstitial` and `InterstitialView` class ([#1269](https://github.com/bkzhn/YouTube.js/issues/1269)) ([bad89d2](https://github.com/bkzhn/YouTube.js/commit/bad89d2657e88f907011655f199fba9fb615c339))
...
* **parser:** Add `ShowSheetCommand` and `SheetView` ([37a4808](https://github.com/bkzhn/YouTube.js/commit/37a480869372831429de439924baabde5d8ac43b))
* **parser:** Add `SignalAction` node ([feeb21b](https://github.com/bkzhn/YouTube.js/commit/feeb21b3ebb83772fcceb1f6b0a90c17db613451))
* **Parser:** Add `ThumbnailOverlayTitleView` and `PageIndicatorView` classes ([#1120](https://github.com/bkzhn/YouTube.js/issues/1120)) ([2a33fbc](https://github.com/bkzhn/YouTube.js/commit/2a33fbc85fd7a25b25696e1a1ab75ed4afde3e10))
...
* **parser:** Add `VideoDescriptionYouchatSectionView` and fix related parsing warnings ([fcb07d3](https://github.com/bkzhn/YouTube.js/commit/fcb07d333ad3cb961fa6afa6a250b903e2016ad6))
* **parser:** Add `VideoSummaryContentView` and `VideoSummaryParagraphView` ([#1153](https://github.com/bkzhn/YouTube.js/issues/1153)) ([da1fac2](https://github.com/bkzhn/YouTube.js/commit/da1fac2d294061229ff550bf08b071206777b97d))
* **parser:** Add `VideoTitleHeaderView` renderer parser ([#1238](https://github.com/bkzhn/YouTube.js/issues/1238)) ([e26e13d](https://github.com/bkzhn/YouTube.js/commit/e26e13d9b7cc511889010c63dee123fd39cb702c))
* **parser:** Add `VideoViewCount` node ([ad448f8](https://github.com/bkzhn/YouTube.js/commit/ad448f8106116e44e65eb5f5351c38fc4a31d809))
* **parser:** Add ContinuationItemView and treat it as a continuation ([#1193](https://github.com/bkzhn/YouTube.js/issues/1193)) ([48ebd1b](https://github.com/bkzhn/YouTube.js/commit/48ebd1b7d43441d9f294161dfa68b65431a8b430))
...
* **Parser:** Add missing `/player/heartbeat` nodes ([#1249](https://github.com/bkzhn/YouTube.js/issues/1249)) ([9b3ee91](https://github.com/bkzhn/YouTube.js/commit/9b3ee912bddebea0711be14d917d969767c01236))
...
* **parser:** Add ThumbnailOverlayAvatarStackView class ([#1200](https://github.com/bkzhn/YouTube.js/issues/1200)) ([14825d7](https://github.com/bkzhn/YouTube.js/commit/14825d7712e32b208830895701973a5a934a3522))
* **parser:** Add TicketEvent and TicketShelf classes ([#1205](https://github.com/bkzhn/YouTube.js/issues/1205)) ([55cf854](https://github.com/bkzhn/YouTube.js/commit/55cf854e324b04517077ddd86ec9d6e031b7bcfe))
...
* **protos:** Add `ClipParams` ([#1215](https://github.com/bkzhn/YouTube.js/issues/1215)) ([a6f8a77](https://github.com/bkzhn/YouTube.js/commit/a6f8a772cbcae54aa109b7cd0730949bae32e901))
...
* **Search:** Add support for refinement chips ([#1167](https://github.com/bkzhn/YouTube.js/issues/1167)) ([f748b8b](https://github.com/bkzhn/YouTube.js/commit/f748b8b3622e20494b10982a6c5b63aade7b23ba))
* **Search:** Update search filters to match YouTube changes ([#1136](https://github.com/bkzhn/YouTube.js/issues/1136)) ([e830396](https://github.com/bkzhn/YouTube.js/commit/e83039637e4d7ac857f437a630a8013d6528a544))
...
* **Session:** Add the `ANDROID_VR` client ([#1149](https://github.com/bkzhn/YouTube.js/issues/1149)) ([f9bd5d0](https://github.com/bkzhn/YouTube.js/commit/f9bd5d0e8db39dcb6c68ccc52446fbaa793e04fa))
* **Session:** Add the `VISIONOS` client ([#1213](https://github.com/bkzhn/YouTube.js/issues/1213)) ([e518645](https://github.com/bkzhn/YouTube.js/commit/e5186450cf9ea781f2b7d397ccace60bc43af367))
...
* **StreamingInfo:** Label Voice Boost audio streams ([#1105](https://github.com/bkzhn/YouTube.js/issues/1105)) ([458f881](https://github.com/bkzhn/YouTube.js/commit/458f88104344fda2e2ca41c9504d946d367a0cb7))
...
* **Channel:** Add support for new feed filter nodes ([#1163](https://github.com/bkzhn/YouTube.js/issues/1163)) ([faaf5fc](https://github.com/bkzhn/YouTube.js/commit/faaf5fc5c15ff93eac8442b2fbdb4767d9a47b3f))
* **ChannelSubMenu:** Handle potential `undefined` values ([543b94c](https://github.com/bkzhn/YouTube.js/commit/543b94c3e4edca29fbd84fcb82fb894d078c28d7))
...
* **Comments.ts:** Add support for threaded comments ([#1194](https://github.com/bkzhn/YouTube.js/issues/1194)) ([c69d19f](https://github.com/bkzhn/YouTube.js/commit/c69d19f8cbe262a31a59e2991060b904f37e5768))
* **CommentView:** Handle undefined endpoint when applying mutations ([#1208](https://github.com/bkzhn/YouTube.js/issues/1208)) ([483c866](https://github.com/bkzhn/YouTube.js/commit/483c866606c1ddf33aece5037a623ee725d0b021))
...
* **ContentMetadataView:** `metadataRows` can be `undefined` ([19b33ea](https://github.com/bkzhn/YouTube.js/commit/19b33ea36e20ef36e483cf24369305f5eca9e5f0))
...
* **FlexibleActionsView:** Update `ActionRow` actions type ([#1129](https://github.com/bkzhn/YouTube.js/issues/1129)) ([5c7b1ba](https://github.com/bkzhn/YouTube.js/commit/5c7b1ba25d17ea0aacf043f402140b217c419f19))
...
* **Format:** Rename `target_duration_dec` to `target_duration_sec` ([0bdd5f1](https://github.com/bkzhn/YouTube.js/commit/0bdd5f198305c40f09f39ea2bf12f686dce02b55))
...
* Handle CommandExecutorCommand in NavigationEndpoint.call ([#968](https://github.com/bkzhn/YouTube.js/issues/968)) ([698121a](https://github.com/bkzhn/YouTube.js/commit/698121ab8f62fbed6e78892277caf93a9890b930))
* **history:** Add support for `LockupView` content ([#1075](https://github.com/bkzhn/YouTube.js/issues/1075)) ([7e10ac9](https://github.com/bkzhn/YouTube.js/commit/7e10ac987347ec380ac52c524d102c99a98d737d))
* **HTTPClient:** add User-Agent header override for ANDROID_VR client ([#1184](https://github.com/bkzhn/YouTube.js/issues/1184)) ([38bc0a3](https://github.com/bkzhn/YouTube.js/commit/38bc0a35d025c2005d7883353adcc08e124c9904))
...
* **Innertube#getHashtag:** Use URL-safe Base64 for hashtag params ([#1211](https://github.com/bkzhn/YouTube.js/issues/1211)) ([c59c8fe](https://github.com/bkzhn/YouTube.js/commit/c59c8fe4525eab1e99f17da7ebe5880c65fb9c0a))
...
* **Innertube:** getChannel() if subscribed ([#1128](https://github.com/bkzhn/YouTube.js/issues/1128)) ([3df4c61](https://github.com/bkzhn/YouTube.js/commit/3df4c61bd7853cc7e9d5c3be13c1ef7a8360807b))
...
* **Innertube:** Remove getTrending as YouTube removed the trending feed ([#1114](https://github.com/bkzhn/YouTube.js/issues/1114)) ([7c144ee](https://github.com/bkzhn/YouTube.js/commit/7c144ee013c2d168d93f203c34f88c8c3bfb4068))
...
* **ItemSection:** ChipBarView parser warning ([#1188](https://github.com/bkzhn/YouTube.js/issues/1188)) ([1b26b83](https://github.com/bkzhn/YouTube.js/commit/1b26b83c2ce6477da206034dc2dc08bee920b3d7))
...
* **MusicResponsiveListItem:** Match a timestamp when reading a music item duration ([#1230](https://github.com/bkzhn/YouTube.js/issues/1230)) ([5df35ac](https://github.com/bkzhn/YouTube.js/commit/5df35aca368459bb0deea6c2d3d1bfdefe41c380))
...
* **parser:** Add `playability_status_memo` to `IPlayerHeartbeatResponse` ([a480854](https://github.com/bkzhn/YouTube.js/commit/a480854c501406cf55c9eb7ad5b540ab36a65b56))
* **parser:** Add `PlayerInterstitial` and `InterstitialView` to ignored list ([43dd935](https://github.com/bkzhn/YouTube.js/commit/43dd9353ba051c012e5b38f7f373a4bc1f113cb3))
...
* **Parser:** Fix ChannelSubMenu parsing ([#1144](https://github.com/bkzhn/YouTube.js/issues/1144)) ([5da9dd3](https://github.com/bkzhn/YouTube.js/commit/5da9dd37a727be792ff4da2c5031cc000d692502))
...
* **parser:** Parse LockupViews in playlist items ([ae90ff4](https://github.com/bkzhn/YouTube.js/commit/ae90ff4f10f647f25a94c36fa5a5fa33c4f1d981))
* **parser:** Resolve some old parser issues ([#1154](https://github.com/bkzhn/YouTube.js/issues/1154)) ([8130f80](https://github.com/bkzhn/YouTube.js/commit/8130f808d9bbccf185c69534b624f15715c739d5)), closes [#653](https://github.com/bkzhn/YouTube.js/issues/653) [#781](https://github.com/bkzhn/YouTube.js/issues/781) [#978](https://github.com/bkzhn/YouTube.js/issues/978) [#1053](https://github.com/bkzhn/YouTube.js/issues/1053) [#695](https://github.com/bkzhn/YouTube.js/issues/695) [#1098](https://github.com/bkzhn/YouTube.js/issues/1098)
...
* **Player:** Add support for new variants ([#1152](https://github.com/bkzhn/YouTube.js/issues/1152)) ([d8558af](https://github.com/bkzhn/YouTube.js/commit/d8558afd58dd6c000669b0dc7c62c666e24bc356))
...
* **Session:** Add the ID for ANDROID_VR, remove the mistaken ANDROID_TV key. ([#1151](https://github.com/bkzhn/YouTube.js/issues/1151)) ([c712c54](https://github.com/bkzhn/YouTube.js/commit/c712c546c3c4b5b3766ac77205ccef683eb51545))
* **Session:** Adjust JSPB parsing logic ([7143efb](https://github.com/bkzhn/YouTube.js/commit/7143efb99add70ebfb65bcaa156f2b77f997bffe))
...
* **SubscriptionButton:** `subscription_type` never being set due to typo ([bffabed](https://github.com/bkzhn/YouTube.js/commit/bffabede8869ff30828f05a61028b56b06e3ffea))
* **SubscriptionButton:** `text` and `subscribed` fields aren't always there ([125b2c2](https://github.com/bkzhn/YouTube.js/commit/125b2c22652db2b33731d957456f2b047d650b21))
...
* **Text:** Handle missing `length` in `attachmentRuns` ([#1241](https://github.com/bkzhn/YouTube.js/issues/1241)) ([c636d81](https://github.com/bkzhn/YouTube.js/commit/c636d81127a3cbf3aae4bbc8fcf0b51a65f73fc7))
...
* **ThumbnailBadgeView:** Parse icon ([#1174](https://github.com/bkzhn/YouTube.js/issues/1174)) ([47b1df7](https://github.com/bkzhn/YouTube.js/commit/47b1df752915e0626fb2fdc8c0d8ca2412e8c94e))
...
* **types:** Parser.parseArray always returns an ObservedArray ([#1014](https://github.com/bkzhn/YouTube.js/issues/1014)) ([8be677a](https://github.com/bkzhn/YouTube.js/commit/8be677adec6631be557c95adc8f687e5d01b4fdf))
...
* **VideoOwner:** Fix a few parsing issues ([782730e](https://github.com/bkzhn/YouTube.js/commit/782730e6ca37c654a72dbe0f3e22180ad7f48188))
...
* **workflow:** Add `id-token` permission for release-please job ([561e69d](https://github.com/bkzhn/YouTube.js/commit/561e69d8b7a1dada852aa24797d728f6b9943413))
...
* **release:** release 17.0.1 ([3cae95c](https://github.com/bkzhn/YouTube.js/commit/3cae95c5314c66029cf97f400f79a99eef03899d))
